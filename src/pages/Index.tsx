    ...
    <Layout>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 container-narrow section-padding">
          ...
          >
            {stats.map((stat) => (
              <div key={stat.label} className="glass-subtle px-4 py-3 rounded-xl text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, i) => (
              <ScrollReveal key={feature.title} delay={i * 0.1}>
                <div className="glass glow-border p-6 h-full hover-lift">
                  <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center mb-4">
                    <feature.icon className="h-5 w-5 text-primary" />
                  </div>
                  <h3 className="font-display text-base font-semibold mb-2 text-foreground">{feature.title}</h3>
      ...
      <section className="section-padding">
        <div className="container-narrow">
          <ScrollReveal>
            <div className="glass glow-border p-8 sm:p-12 lg:p-16 text-center relative overflow-hidden">
